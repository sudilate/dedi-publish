        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-muted-foreground mb-4 max-w-xs">
              Your professional solution for modern web applications with secure authentication.
            </p>
          </div>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex gap-6 mt-4 md:mt-0">
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
              <svg className="h-5 w-5 text-muted-foreground hover:text-primary transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
